...
public partial class LazyTabbedPage : ContentPage, IContentView
{
    ...
    public static readonly BindableProperty NavigatorBarProperty =
            BindableProperty.Create (nameof (NavigatorBarProperty), typeof (View), typeof (LazyTabbedPage), default (View), propertyChanged : (bindalble, oldValue, newValue)=>
            {
    ...
    public View NavigatorBar
    {
        get => (View)GetValue (NavigatorBarProperty);
        set { SetValue (NavigatorBarProperty, value); }
    }
